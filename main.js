    ...
    let deletyourtask = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: "what would you like to delet in your todos enter a index number:",
        },
    ]);
    ...
    let update_task_index = await inquirer.prompt([
        {
            name: "index",
            type: "number",
            message: "what task you want to update plaese enter your index number which you wanna update:",
        },
        {
            name: "new_task",
            type: "input",
